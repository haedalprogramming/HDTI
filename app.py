...
def result():
    ...
    if result_list[0].isdigit():
        ...
        type_name = result_list

    if 'AREI' in type_name:
        img_src = '../static/img/매기_움짤.gif'
        img_og = '/static/img/thumnail/매기.png'
        type_ex = '괴짜 프로그래머'
    ...
    elif 'AREP' in type_name:
        img_src = '../static/img/흐규_움짤.gif'
        img_og = '/static/img/thumnail/흐규.png'
        type_ex = '소심한 아이디어뱅크'
    ...
    elif 'ARCI' in type_name:
        img_src = '../static/img/시라용_움짤.gif'
        img_og = '/static/img/thumnail/시라용.png'
        type_ex = '에디슨형'
    ...
    elif 'ARCP' in type_name:
        img_src = '../static/img/해달이_움짤.gif'
        img_og = '/static/img/thumnail/해달이.png'
        type_ex = '극한의 효율형'
    ...
    elif 'AFEI' in type_name:
        img_src = '../static/img/김두근_움짤.gif'
        img_og = '/static/img/thumnail/김두근.png'
        type_ex = '코딩계 마당발'
    ...
    elif 'AFEP' in type_name:
        img_src = '../static/img/스팸_움짤.gif'
        img_og = '/static/img/thumnail/스팸.png'
        type_ex = '지옥에서 온 개발자'
    ...
    elif 'AFCI' in type_name:
        img_src = '../static/img/아리_움짤.gif'
        img_og = '/static/img/thumnail/아리.png'
        type_ex = '내일은 코딩왕'
    ...
    elif 'AFCP' in type_name:
        img_src = '../static/img/부기_움짤.gif'
        img_og = '/static/img/thumnail/부기.png'
        type_ex = '꾸준한 거북이'
    ...
    elif 'TREP' in type_name:
        img_src = '../static/img/사스미_움짤.gif'
        img_og = '/static/img/thumnail/사스미.png'
        type_ex = '유니콘형'
    ...
    return render_template('result.html', img=img_src, type=type_name, explanation=explanation, type_ex=type_ex, img_og=img_og)

@app.route('/types')
def types():
    typeslist = ['AREI', 'AREP', 'ARCI', 'ARCP',
                 'AFEI', 'AFEP', 'AFCI', 'AFCP',
                 'TREI', 'TREP', 'TRCI', 'TRCP',
                 'TFEI', 'TFEP', 'TFCI', 'TFCP']
    explainlist = ['괴짜<br>프로그래머', '소심한<br>아이디어뱅크', '에디슨형', '극한의<br>효율형',
                   '코딩계<br>마당발', '지옥에서 온<br>개발자', '내일은<br>코딩왕', '꾸준한<br>거북이',
                   '환상의<br>효율장인', '유니콘형', '코딩계<br>스파크', '기가지니',
                   '인스타스타', '조별과제의<br>왕', '아이디어<br>뱅크', '회장의<br>재목']

    return render_template('types.html', typeslist=typeslist, explainlist=explainlist)
