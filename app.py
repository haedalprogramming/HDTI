...
def result():
    ...
    typefromresult = request.form['typeInput']
    print(typefromresult)
    ...
    elif type_name == 'AREP' or typefromresult == 'AREP':
    ...
    elif type_name == 'ARCI' or typefromresult == 'ARCI':
    ...
    elif type_name == 'ARCP' or typefromresult == 'ARCP':
    ...
    elif type_name == 'AFEI' or typefromresult == 'AFEI':
    ...
    elif type_name == 'AFEP' or typefromresult == 'AFEP':
    ...
    elif type_name == 'AFCI' or typefromresult == 'AFCI':
    ...
    elif type_name == 'AFCP' or typefromresult == 'AFCP':
    ...
    elif type_name == 'TREI' or typefromresult == 'TREI':
        img_src = '../static/img/매기_움짤.gif'
        type_ex = '환상의 효율장인'
    ...
    elif type_name == 'TREP' or typefromresult == 'AFEP':
    ...
    elif type_name == 'TRCI' or typefromresult == 'TRCI':
        img_src = '../static/img/부기_움짤.gif'
        type_ex = '코딩계 스파크'
    ...
    elif type_name == 'TRCP' or typefromresult == 'TRCP':
        img_src = '../static/img/시라용_움짤.gif'
        type_ex = '기가지니'
    ...
    elif type_name == 'TFEI' or typefromresult == 'TFEI':
        img_src = '../static/img/김두근_움짤.gif'
        type_ex = '인스타스타'
    ...
    elif type_name == 'TFEP' or typefromresult == 'TFEP':
        img_src = '../static/img/흐규_움짤.gif'
        type_ex = '조별과제의 왕'
    ...
    elif type_name == 'TFCI' or typefromresult == 'TFCI':
        img_src = '../static/img/아리_움짤.gif'
        type_ex = '아이디어 뱅크'
    ...
    elif type_name == 'TFCP' or typefromresult == 'TFCP':
        img_src = '../static/img/해달이_움짤.gif'
        type_ex = '회장의 재목'
